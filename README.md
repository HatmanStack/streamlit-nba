...
This repository has a Streamlit app that lets you create a NBA fantasy team and compete against computer-generated teams. The app uses a local CSV file that contains historical NBA player data.
